...
if __name__ == '__main__':
    ...
    struminput1 = [ [[20.5,20.5,50,endp[0]],[1.5,1.5,1,5]], [[-55.9,-55.9,endp[1]],[3,1,5]], [[-4.4,33,endp[2]],[2,4,3]], [[70,12.8,14.8, 125,endp[3]],[1.5,2,1,2.5,2.5]], [[0,0,70,endp[4]],[2,3,2,2]], [[60,30,30,-10,endp[5]],[2,2,0.5,1.5,3]], [[-45,-45,endp[6]],[1,8.5,0.5]] ]
    vstrum1 = dancevel(overlap-prepTime)
    vfstrum1 = dancevel(overlap)
    strumtraj1 = matlabparser(struminput1,vstrum1,vfstrum1,strumIP1)

    strumIP2 = dancepos(IPstring,((overlap*2)-prepTime))
